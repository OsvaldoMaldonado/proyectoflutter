...
class login_usuario extends StatelessWidget{
  ...
  TextEditingController entrada_login_NombreCorreo = new TextEditingController();
  TextEditingController entrada_login_NombreContra = new TextEditingController();
  String getvalue = "";
  String getvalue2 = "";
  @override
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: screenheight * 0.05,child: Text('Contraseña'),),
            Row(
              children: <Widget>[
                Spacer(),
