          ...
          child: FutureBuilder<User?>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                ...
                return Perfil(perfil: snapshot.data!, id: idUser);
              } else {
                return const Center(
...
class Perfil extends StatefulWidget {
  const Perfil({Key? key, required this.perfil, required this.id}) : super(key: key);
        ...
        children: <Widget>[
                      ...
                      setState(() {
                        ...
                        if (contador1 == 0) {
                          ...
                          if (contador1 == 1) {
                            ...
                            visibilidad2 = false;
                            modificarusuario(widget.id, getvalue);
                            contador1 = 0;
                            UserProfileScreen();
                          }
                          ;
          ...
          Container(
            ...
            child: Row(
                ...
                children: <Widget>[
                  Visibility(
                      visible: visibilidad5,
                      child: Text(
                        "Correo:   " + widget.perfil.correo,
                        textAlign: TextAlign.left,
                        style: const TextStyle(fontSize: 18),
                      )),
                  Visibility(
                    visible: visibilidad6,
                    child: SizedBox(
                      width: screenSize * 0.70,
                      height: screenHeight * 0.07,
                      child: TextField(
          ...
          Container(
            ...
            child: Row(
                ...
                children: <Widget>[
                  Visibility(
                      visible: visibilidad7,
                      child: Text(
                        "Telefono:   " + widget.perfil.telefono,
                        textAlign: TextAlign.left,
                        style: const TextStyle(fontSize: 18),
                      )),
                  Visibility(
                    visible: visibilidad8,
                    child: SizedBox(
                      width: screenSize * 0.70,
                      height: screenHeight * 0.07,
                      child: TextField(
