        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                Text("Correo Electronico >   " + perfil.correo, textAlign: TextAlign.left,style: const TextStyle(fontSize: 18),),
                const InkWell(
          ...
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
              Text("Nombre >   " + perfil.nombre, textAlign: TextAlign.left,style: const TextStyle(fontSize: 18),),
              const InkWell(
                  child: Text('Editar', style: TextStyle(color: Colors.grey, fontSize: 14),textAlign: TextAlign.end,),
                ),
              ],
          ...
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
              Text("Apellido >   " + perfil.apellido, textAlign: TextAlign.left,style: const TextStyle(fontSize: 18),),
              const InkWell(
                  child: Text('Editar', style: TextStyle(color: Colors.grey, fontSize: 14),textAlign: TextAlign.end,),
                ),
              ],
          ...
          Container(
            ...
            child: Row(                  
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
              Text("Telefono >  " + perfil.telefono, textAlign: TextAlign.left,style: const TextStyle(fontSize: 18),),
              const InkWell(
                  child: Text('Editar', style: TextStyle(color: Colors.grey, fontSize: 14),textAlign: TextAlign.end,),
                ),
              ],
